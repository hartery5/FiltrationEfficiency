...
function updateText(){
    ...
    text(addunit(FTOT1,'%'),285,157.5);
    text("Total Filtration Efficiency (Photometer):",10,182.5);
    text(addunit(FTOT2,'%'),285,182.5);  
    text("Methodological Bias (SMPS-Photometer):",10,207.5);
    text(addunit(FTOT1-FTOT2,'%'),285,207.5);
    text("Pressure Drop:",10,232.5);
    text(addunit(DP,'Pa'),285,232.5);  
    text("Most Penetrating Particle Size:",10,257.5);
    text(addunit(MPPS*1e9,'nm'),285,257.5);
    text("Flow Rate:",10,282.5);
    text(addunit(_U*100.*141.8/16.67,'L min^-1'),285,282.5);
